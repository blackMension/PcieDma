...
TOP_LEVEL_NAME="Phy_rst.Phy_rst"
QSYS_SIMDIR="./../"
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/../altera_xcvr_reset_control_171/sim/altera_xcvr_functions.sv"     -work altera_xcvr_reset_control_171 -cdslib ./cds_libs/altera_xcvr_reset_control_171.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/../altera_xcvr_reset_control_171/sim/alt_xcvr_resync.sv"           -work altera_xcvr_reset_control_171 -cdslib ./cds_libs/altera_xcvr_reset_control_171.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/../altera_xcvr_reset_control_171/sim/altera_xcvr_reset_control.sv" -work altera_xcvr_reset_control_171 -cdslib ./cds_libs/altera_xcvr_reset_control_171.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/../altera_xcvr_reset_control_171/sim/alt_xcvr_reset_counter.sv"    -work altera_xcvr_reset_control_171 -cdslib ./cds_libs/altera_xcvr_reset_control_171.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Phy_rst.v"                                                         -work Phy_rst                                                                               
fi
