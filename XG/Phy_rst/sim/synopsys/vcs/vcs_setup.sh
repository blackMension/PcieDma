...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/../altera_xcvr_reset_control_171/sim/altera_xcvr_functions.sv \
  $QSYS_SIMDIR/../altera_xcvr_reset_control_171/sim/alt_xcvr_resync.sv \
  $QSYS_SIMDIR/../altera_xcvr_reset_control_171/sim/altera_xcvr_reset_control.sv \
  $QSYS_SIMDIR/../altera_xcvr_reset_control_171/sim/alt_xcvr_reset_counter.sv \
