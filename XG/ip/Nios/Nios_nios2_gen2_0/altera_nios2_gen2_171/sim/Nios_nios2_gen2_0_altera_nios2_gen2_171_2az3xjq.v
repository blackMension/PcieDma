// Nios_nios2_gen2_0_altera_nios2_gen2_171_2az3xjq.v
...
`timescale 1 ps / 1 ps
module Nios_nios2_gen2_0_altera_nios2_gen2_171_2az3xjq (
	...
	Nios_nios2_gen2_0_altera_nios2_gen2_unit_171_yoexwey cpu (
		.clk                                 (clk),                                 //   input,   width = 1,                       clk.clk
		.reset_n                             (reset_n),                             //   input,   width = 1,                     reset.reset_n
		.reset_req                           (reset_req),                           //   input,   width = 1,                          .reset_req
		.d_address                           (d_address),                           //  output,  width = 21,               data_master.address
		...
		.i_address                           (i_address),                           //  output,  width = 21,        instruction_master.address
