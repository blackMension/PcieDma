	Nios_nios2_gen2_0 u0 (
		...
		.i_address                           (_connected_to_i_address_),                           //  output,  width = 21,        instruction_master.address
