	XG_inst_avalon_st_rx_bfm_ip #(
		...
		.sink_data          (_connected_to_sink_data_),          //   input,  width = 64,      sink.data
		.sink_valid         (_connected_to_sink_valid_),         //   input,   width = 1,          .valid
		.sink_ready         (_connected_to_sink_ready_),         //  output,   width = 1,          .ready
		.sink_startofpacket (_connected_to_sink_startofpacket_), //   input,   width = 1,          .startofpacket
		.sink_endofpacket   (_connected_to_sink_endofpacket_),   //   input,   width = 1,          .endofpacket
		.sink_empty         (_connected_to_sink_empty_),         //   input,   width = 3,          .empty
		.sink_error         (_connected_to_sink_error_)          //   input,   width = 6,          .error
	);
