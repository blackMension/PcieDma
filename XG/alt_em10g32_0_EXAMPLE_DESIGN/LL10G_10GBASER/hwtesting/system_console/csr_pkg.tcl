...
proc read_address_inserter {} {
    ...
    puts "==============================================================================\n\n"
    puts "control status : [rd32 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $ADDRESS_INSERTER_BASE_ADDR 0x0]\n"
    puts "MAC src addr 0 : [rd32 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $ADDRESS_INSERTER_BASE_ADDR 0x4]\n"
    puts "MAC src addr 1 : [rd32 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $ADDRESS_INSERTER_BASE_ADDR 0x8]\n"
}
...
proc write_MAC_src_address {value} {
    ...
    wr32 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $ADDRESS_INSERTER_BASE_ADDR $offset $lowerMAC

    set offset 0x8
    set higherMAC [string range $value 0 5]
    puts "Write to offset $offset of Address Inserter with value of $higherMAC\n"
    wr32 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $ADDRESS_INSERTER_BASE_ADDR $offset $higherMAC
}
...
proc set_address_inserter {value} {
    ...
    wr32 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $ADDRESS_INSERTER_BASE_ADDR $offset $value
}
...
proc read_stats {path} {
    ...
    if {$read_error == 0x0} {
        puts "clr : [rd32 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0x00]\n"
        puts "framesOK : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0x08]\n"
        puts "framesErr : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0x10]\n"
        puts "framesCRCErr : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0x18]\n"
        puts "octetsOK : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0x20]\n"
        puts "pauseMACCtrlFrames : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0x28]\n"
        puts "ifErrors : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0x30]\n"
        puts "unicastFramesOK : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0x38]\n"
        puts "unicastFramesErr : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0x40]\n"
        puts "multicastFramesOK : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0x48]\n"
        puts "multicastFramesErr : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0x50]\n"
        puts "broadcastFramesOK : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0x58]\n"
        puts "broadcastFramesErr : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0x60]\n"
        puts "etherStatsOctets : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0x68]\n"
        puts "etherStatsPkts : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0x70]\n"
        puts "etherStatsUnderSizePkts : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0x78]\n"
        puts "etherStatsOversizePkts : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0x80]\n"
        puts "etherStatsPkts64Octets : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0x88]\n"
        puts "etherStatsPkts65to127Octets : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0x90]\n"
        puts "etherStatsPkts128to255Octets : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0x98]\n"
        puts "etherStatsPkts256to511Octet : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0xA0]\n"
        puts "etherStatsPkts512to1023Octets : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0xA8]\n"
        puts "etherStatsPkts1024to1518Octets : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0xB0]\n"
        puts "etherStatsPkts1518toXOctets : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0xB8]\n"
        puts "etherStatsFragments : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0xC0]\n"
        puts "etherStatsJabbers : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0xC8]\n"
        puts "etherStatsCRCErr : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0xD0]\n"
        puts "unicastMACCtrlFrames : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0xD8]\n"
        puts "multicastMACCtrlFrames : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0xE0]\n"
        puts "broadcastMACCtrlFrames : [rd64 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $base_address 0xE8]\n" 
   }      
}
...
proc clear_stats {} {
    ...
    wr32 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $RX_STATISTICS_BASE_ADDR 0x0 0x1
    
    puts "Clear TX statistics registers\n"
    wr32 [expr {$CHANNEL*0x10000 + $MAC_BASE_ADDR}] $TX_STATISTICS_BASE_ADDR 0x0 0x1
