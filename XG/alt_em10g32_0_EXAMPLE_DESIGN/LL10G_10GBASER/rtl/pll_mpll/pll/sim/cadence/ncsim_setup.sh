...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../altera_iopll_171/sim/pll_altera_iopll_171_ejgq7kq.vo" -work altera_iopll_171 -cdslib ./cds_libs/altera_iopll_171.cds.lib
