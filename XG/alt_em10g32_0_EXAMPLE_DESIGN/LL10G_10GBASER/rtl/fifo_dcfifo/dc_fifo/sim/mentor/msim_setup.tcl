...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/dc_fifo/dc_fifo_0/altera_avalon_dc_fifo_171/sim/altera_avalon_dc_fifo.v"             -work altera_avalon_dc_fifo_171
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/dc_fifo/dc_fifo_0/altera_avalon_dc_fifo_171/sim/altera_dcfifo_synchronizer_bundle.v" -work altera_avalon_dc_fifo_171
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/dc_fifo/dc_fifo_0/altera_avalon_dc_fifo_171/sim/altera_std_synchronizer_nocut.v"     -work altera_avalon_dc_fifo_171
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_avalon_dc_fifo_171 -L dc_fifo_0 -L dc_fifo -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_avalon_dc_fifo_171 -L dc_fifo_0 -L dc_fifo -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
