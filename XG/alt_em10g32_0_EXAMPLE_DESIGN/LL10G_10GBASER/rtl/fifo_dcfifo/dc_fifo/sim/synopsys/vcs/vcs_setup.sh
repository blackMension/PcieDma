...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/../../ip/dc_fifo/dc_fifo_0/altera_avalon_dc_fifo_171/sim/altera_avalon_dc_fifo.v \
  $QSYS_SIMDIR/../../ip/dc_fifo/dc_fifo_0/altera_avalon_dc_fifo_171/sim/altera_dcfifo_synchronizer_bundle.v \
  $QSYS_SIMDIR/../../ip/dc_fifo/dc_fifo_0/altera_avalon_dc_fifo_171/sim/altera_std_synchronizer_nocut.v \
