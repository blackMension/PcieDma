...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/../../ip/sc_fifo/sc_fifo_tx_sc_fifo/altera_avalon_sc_fifo_171/sim/altera_avalon_sc_fifo.v \
  $QSYS_SIMDIR/../../ip/sc_fifo/sc_fifo_tx_sc_fifo/sim/sc_fifo_tx_sc_fifo.v \
  $QSYS_SIMDIR/../../ip/sc_fifo/sc_fifo_rx_sc_fifo/sim/sc_fifo_rx_sc_fifo.v \
