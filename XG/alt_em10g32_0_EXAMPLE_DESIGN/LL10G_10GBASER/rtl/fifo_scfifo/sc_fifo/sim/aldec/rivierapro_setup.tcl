...
# ACDS 17.1.2 304 linux 2019.05.31.10:48:48
# ----------------------------------------
...
ensure_lib                           ./libraries/sc_fifo_tx_sc_fifo       
vmap       sc_fifo_tx_sc_fifo        ./libraries/sc_fifo_tx_sc_fifo       
ensure_lib                           ./libraries/sc_fifo_rx_sc_fifo       
vmap       sc_fifo_rx_sc_fifo        ./libraries/sc_fifo_rx_sc_fifo       
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/sc_fifo/sc_fifo_tx_sc_fifo/altera_avalon_sc_fifo_171/sim/altera_avalon_sc_fifo.v" -work altera_avalon_sc_fifo_171
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/sc_fifo/sc_fifo_tx_sc_fifo/sim/sc_fifo_tx_sc_fifo.v"                              -work sc_fifo_tx_sc_fifo       
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/sc_fifo/sc_fifo_rx_sc_fifo/altera_avalon_sc_fifo_171/sim/altera_avalon_sc_fifo.v" -work altera_avalon_sc_fifo_171
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/sc_fifo/sc_fifo_rx_sc_fifo/sim/sc_fifo_rx_sc_fifo.v"                              -work sc_fifo_rx_sc_fifo       
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L altera_avalon_sc_fifo_171 -L sc_fifo_tx_sc_fifo -L sc_fifo_rx_sc_fifo -L sc_fifo -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L altera_avalon_sc_fifo_171 -L sc_fifo_tx_sc_fifo -L sc_fifo_rx_sc_fifo -L sc_fifo -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
