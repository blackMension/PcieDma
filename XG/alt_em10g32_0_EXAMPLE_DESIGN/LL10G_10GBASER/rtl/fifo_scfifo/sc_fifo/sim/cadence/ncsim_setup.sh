...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../../ip/sc_fifo/sc_fifo_tx_sc_fifo/altera_avalon_sc_fifo_171/sim/altera_avalon_sc_fifo.v" -work altera_avalon_sc_fifo_171 -cdslib ./cds_libs/altera_avalon_sc_fifo_171.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/sc_fifo/sc_fifo_tx_sc_fifo/sim/sc_fifo_tx_sc_fifo.v"                              -work sc_fifo_tx_sc_fifo                                                            
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../../ip/sc_fifo/sc_fifo_rx_sc_fifo/altera_avalon_sc_fifo_171/sim/altera_avalon_sc_fifo.v" -work altera_avalon_sc_fifo_171 -cdslib ./cds_libs/altera_avalon_sc_fifo_171.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/sc_fifo/sc_fifo_rx_sc_fifo/sim/sc_fifo_rx_sc_fifo.v"                              -work sc_fifo_rx_sc_fifo                                                            
