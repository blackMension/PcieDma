...
module address_decode_altera_merlin_router_171_bqlzivi_default_decode
  #(
...
module address_decode_altera_merlin_router_171_bqlzivi
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    address_decode_altera_merlin_router_171_bqlzivi_default_decode the_default_decode(
