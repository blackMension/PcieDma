...
module DUT_pcie_tb_ip #(
	...
	altpcie_a10_tbed_hwtcl #(
		...
		.sim_ltssmstate   (sim_ltssmstate),   //   input,   width = 5,           .sim_ltssmstate
		.eidleinfersel0   (eidleinfersel0),   //   input,   width = 3,           .eidleinfersel0
		.eidleinfersel1   (eidleinfersel1),   //   input,   width = 3,           .eidleinfersel1
		.eidleinfersel2   (eidleinfersel2),   //   input,   width = 3,           .eidleinfersel2
		.eidleinfersel3   (eidleinfersel3),   //   input,   width = 3,           .eidleinfersel3
		.eidleinfersel4   (eidleinfersel4),   //   input,   width = 3,           .eidleinfersel4
		.eidleinfersel5   (eidleinfersel5),   //   input,   width = 3,           .eidleinfersel5
		.eidleinfersel6   (eidleinfersel6),   //   input,   width = 3,           .eidleinfersel6
		.eidleinfersel7   (eidleinfersel7),   //   input,   width = 3,           .eidleinfersel7
		...
		.test_in          (test_in),          //  output,  width = 32,   hip_ctrl.test_in
