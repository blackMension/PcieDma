...
ELAB_OPTIONS="+incdir+../../../../../MyCode/src"
SIM_OPTIONS=""
...
vcs -full64 -lca -cpp g++-4.8 -cc gcc-4.8 -LDFLAGS -Wl,--no-as-needed -f filelist.f -timescale=1ps/1ps -sverilog +v2k +verilog2001ext+.v +lint=TFIPC-L -l compile.log  -warn=IWNF -assert enable_diag $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
