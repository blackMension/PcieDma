...
module ep_g3x8_avmm256_DUT (
	...
	ep_g3x8_avmm256_DUT_altera_pcie_a10_hip_171_ik6fnxi #(
		...
		.bar4_address_width_mux_hwtcl                       (15),
		...
		.include_dma_hwtcl                                  (1),
		.txs_addr_width_integer_hwtcl                       (32),
		...
		.msix_table_offset_hwtcl                            (32'b00000000000000000000000000000000),
		.msix_pba_offset_hwtcl                              (32'b00000000000000000000000000000000),
		...
		.txs_address_i                  (txs_address_i),                                                                                                                                                                                                                                                         //   input,   width = 32,               txs.address
		...
		.rxm_bar0_byteenable_o          (rxm_bar0_byteenable_o),                                                                                                                                                                                                                                                 //  output,    width = 4,                  .byteenable
		.rxm_bar0_readdata_i            (rxm_bar0_readdata_i),                                                                                                                                                                                                                                                   //   input,   width = 32,                  .readdata
		.rxm_bar0_writedata_o           (rxm_bar0_writedata_o),                                                                                                                                                                                                                                                  //  output,   width = 32,                  .writedata
		...
		.rxm_bar4_address_o             (rxm_bar4_address_o),                                                                                                                                                                                                                                                    //  output,   width = 64,          rxm_bar4.address
		.rxm_bar4_byteenable_o          (rxm_bar4_byteenable_o),                                                                                                                                                                                                                                                 //  output,    width = 4,                  .byteenable
		.rxm_bar4_readdata_i            (rxm_bar4_readdata_i),                                                                                                                                                                                                                                                   //   input,   width = 32,                  .readdata
		.rxm_bar4_writedata_o           (rxm_bar4_writedata_o),                                                                                                                                                                                                                                                  //  output,   width = 32,                  .writedata
		.rxm_bar4_read_o                (rxm_bar4_read_o),                                                                                                                                                                                                                                                       //  output,    width = 1,                  .read
		.rxm_bar4_write_o               (rxm_bar4_write_o),                                                                                                                                                                                                                                                      //  output,    width = 1,                  .write
		.rxm_bar4_readdatavalid_i       (rxm_bar4_readdatavalid_i),                                                                                                                                                                                                                                              //   input,    width = 1,                  .readdatavalid
		.rxm_bar4_waitrequest_i         (rxm_bar4_waitrequest_i),                                                                                                                                                                                                                                                //   input,    width = 1,                  .waitrequest
		.rd_ast_rx_valid_i              (rd_ast_rx_valid_i),                                                                                                                                                                                                                                                     //   input,    width = 1,         rd_ast_rx.valid
		.rd_ast_rx_data_i               (rd_ast_rx_data_i),                                                                                                                                                                                                                                                      //   input,  width = 160,                  .data
		.rd_ast_rx_ready_o              (rd_ast_rx_ready_o),                                                                                                                                                                                                                                                     //  output,    width = 1,                  .ready
		.rd_ast_tx_valid_o              (rd_ast_tx_valid_o),                                                                                                                                                                                                                                                     //  output,    width = 1,         rd_ast_tx.valid
		.rd_ast_tx_data_o               (rd_ast_tx_data_o),                                                                                                                                                                                                                                                      //  output,   width = 32,                  .data
		.wr_ast_rx_valid_i              (wr_ast_rx_valid_i),                                                                                                                                                                                                                                                     //   input,    width = 1,         wr_ast_rx.valid
		.wr_ast_rx_data_i               (wr_ast_rx_data_i),                                                                                                                                                                                                                                                      //   input,  width = 160,                  .data
		.wr_ast_rx_ready_o              (wr_ast_rx_ready_o),                                                                                                                                                                                                                                                     //  output,    width = 1,                  .ready
		.wr_ast_tx_valid_o              (wr_ast_tx_valid_o),                                                                                                                                                                                                                                                     //  output,    width = 1,         wr_ast_tx.valid
		.wr_ast_tx_data_o               (wr_ast_tx_data_o),                                                                                                                                                                                                                                                      //  output,   width = 32,                  .data
		...
		.rxm_bar2_readdata_i            (32'b00000000000000000000000000000000),                                                                                                                                                                                                                                  // (terminated),                                 
